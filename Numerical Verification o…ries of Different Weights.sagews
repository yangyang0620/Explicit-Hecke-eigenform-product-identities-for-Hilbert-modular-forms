︠1aad74ae-2900-4426-ac0b-58892f7b0d67s︠
##############################################################################
# Title: Numerical Verification of Eigenform Product Identities (Eisenstein-Eisenstein Case)
# Description:
...
x = polygen(QQ, 'x')
K.<a> = NumberField(x^2 - d, embedding=1.0)
